                    ...
                    <table class="table table-striped table-class" id= "table-id">
                        ...
                        <tbody>
                            <c:forEach items="${patients}" var="patient" varStatus="loop">
                                <tr>
                                    <td> <a class="text-heading font-semibold" href="viewPrescriptionDetail?pid=${patient.id}">${patient.name}</a></td>
                                    <td>${patient.email}</td>
                                    <td>${patient.phone}</td>
                                    <td>${patient.address}</td>
                                    <td class="text-end">
                                                        <a href="viewPrescriptionDetail?pid=${patient.id}" class="btn btn-sm btn-neutral">View</a>
...
</body><script>  getPagination('#table-id');

                    ...
                    <div class="profile-info col-md-9">      
                        <div class="panel">       
                            <div class="panel-body bio-graph-info">
                                ...
                                <div class="row">
                                    <div class="bio-row">
                                        <p><span>Name </span>: ${pa.name}</p>
                                    </div>
                                    <div class="bio-row">
                                        <p><span>Address </span>: ${pa.address}</p>
                                    </div>
                                    <div class="bio-row">
                                        <p><span>Gender </span>: <span id="gender">${pa.gender}</span></p>
                                    </div>
                                    <div class="bio-row">
                                        <p><span>Birthday</span>: ${pa.dob}</p>
                                    </div>
                                    <div class="bio-row">
                                        <p><span>Phone </span>: ${pa.phone}</p>
                                    </div>
                                    <div class="bio-row">
                                        <p><span>Email </span>: ${pa.email}</p>
                                    </div>
                                    <div class="bio-row">
                                        <p><span>SIN </span>: ${pa.sin}</p>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="panel">
                                        <div class="panel-body">
                                            ...
                                            <div class="bio-desk">
                                                <h4 class="red">Exam Result</h4>
                                                <p>Date: ${pre.patientExamResult.exam_date}</p>

                                                <p>Symptoms: ${pre.patientExamResult.symptoms}</p>
                                                <p>Diagnosis: ${pre.patientExamResult.diagnosis}</p>
                                                <p>Test Result: ${pre.patientExamResult.test_result}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="panel">
                                        <div class="panel-body">
                                            ...
                                            <div class="bio-desk">
                                                <h4 class="green">Prescription</h4>
                                                <p>Date: ${pre.prescription_date}</p>
                                                <p>Medication: ${pre.medication}</p>
                                                <p>Dosage: ${pre.dosage}</p>
                                                <p>Duration: ${pre.duration}</p>
                                                <p>Notes: ${pre.notes}</p>                                             
                                            </div>
                                        </div>
                                    </div>
...
</body><script>const genderElement = document.getElementById('gender');
    const gender = genderElement.textContent;
    genderElement.textContent = gender === 'F' ? 'Female' : gender === 'M' ? 'Male' : 'Unknown';</script>
</html>
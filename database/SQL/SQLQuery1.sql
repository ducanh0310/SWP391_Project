...
CREATE TABLE [dbo].[Patient_records](
	...
	[patient_id] [int] NOT NULL FOREIGN KEY REFERENCES Persons([patient_id]),
	)
GO
...
INSERT [dbo].[Employee] ([employee_sin], [employee_type], [name], [address], [annual_salary], [branch_id]) VALUES (158453648, N'd', N'Céline Wan', N'123 Postgres Street, Ottawa, ON, Canada', CAST(75000.50 AS Numeric(10, 2)), 1)
...
GO
INSERT [dbo].[Patient_info] ( [patient_sin], [address], [name], [gender], [email], [phone], [date_of_birth], [insurance], [rep_id]) VALUES (164645466, N'123 Sesame Street', N'Elmo Lee', N'M', N'elmo@elmail.com', N'6664206969', CAST(N'2000-01-01' AS Date), NULL, NULL)
INSERT [dbo].[Patient_info] ([patient_sin], [address], [name], [gender], [email], [phone], [date_of_birth], [insurance], [rep_id]) VALUES ( 111111111, N'529 Random Road', N'Stephie McRandom', N'F', N'random@gmail.com', N'1231231234', CAST(N'2012-01-01' AS Date), N'Random Insurance Company Inc.', 1)
INSERT [dbo].[Patient_info] ( [patient_sin], [address], [name], [gender], [email], [phone], [date_of_birth], [insurance], [rep_id]) VALUES ( 111111112, N'529 Random Road', N'Paul McRandomee', N'M', N'randomee@gmail.com', N'5551231234', CAST(N'2008-01-01' AS Date), N'Random Insurance Company Inc.', 2)
INSERT [dbo].[Patient_info] ( [patient_sin], [address], [name], [gender], [email], [phone], [date_of_birth], [insurance], [rep_id]) VALUES ( 515151547, N'525 Elgin Street', N'Brooke Lay', N'F', N'brooke@gamil.com', N'3436589636', CAST(N'2002-06-08' AS Date), NULL, NULL)
INSERT [dbo].[Patient_info] ( [patient_sin], [address], [name], [gender], [email], [phone], [date_of_birth], [insurance], [rep_id]) VALUES ( 388498874, N'1225 Imaginary Street, Toronto, ON, Canada', N'John Li', N'M', N'john@gmail.com', N'3437826548', CAST(N'2000-09-03' AS Date), NULL, NULL)
...
INSERT [dbo].[Review] ( [dentist_name], [review_description], [professionalism], [communication], [cleanliness], [date_of_review], [procedure_id]) VALUES ( N'Céline Wan', N'I could not believe the service I received for this appointment. Absolutely horrible. You will be hearing about me on Yelp!!!', 1, 1, 2, CAST(N'2022-04-10' AS Date), 2)

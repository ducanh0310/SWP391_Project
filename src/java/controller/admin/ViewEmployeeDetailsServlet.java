 ...
 * @author trung
 */
@WebServlet(name = "ViewEmployeeDetailsServlet", urlPatterns = {"/ViewEmployeeDetailsServlet"})
public class ViewEmployeeDetailsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewEmployeeDetailsServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewEmployeeDetailsServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
     ...
     * @throws IOException if an I/O error occurs
     */
    //Send user to employee details information page
    @Override

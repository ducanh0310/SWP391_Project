 ...
 * @author trung
 */
@WebServlet(name = "ViewEmployeeList", urlPatterns = {"/ViewEmployeeList"})
public class ViewEmployeeList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewEmployeeList</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewEmployeeList at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
     ...
     * @throws IOException if an I/O error occurs
     */
    //send admin to list of employee
    @Override

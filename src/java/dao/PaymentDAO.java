...
public class PaymentDAO extends DBContext {
    ...
    public int insertPayment(int idAppointment, String money) throws SQLException {
        String sql = """
    ...
    public ArrayList<BookingAppointmentHistory> paymentPersonalSlot(int idAppointment) throws SQLException {
    ...
    //check to identify: can pay?
    public ArrayList<BookingAppointmentHistory> paymentAllSlot(int idAppointment) throws SQLException {
        ArrayList<BookingAppointmentHistory> arrBA = new ArrayList<>();

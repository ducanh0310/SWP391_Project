        ...
        <div class="col-lg-6">
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    ...
                    <form action="ConfirmEmailForgotPw" method="GET">
                        <div class="mb-3">
                            <labe class="form-label">The authentication code will be sent via gmail to <strong style="font: bold"> ${emailFP}</strong>. If you didn't get the email, check your junk folder or <a href="#" onclick="window.location.reload();">Try again</a></label>
                                <input type="text" class="form-control" id="codeCf" name="codeCf" placeholder="" required>
                                <span class="text-danger">
                                            <%
                                                String timeout = (String) request.getAttribute("timeout");
                                                String incorrectCode = (String) request.getAttribute("incorrectCode");
                                                String error = (String) request.getAttribute("error");
                                                if (timeout != null) {
                                            %>
                                            <%= timeout %>
                                            <%
                                            } else if (incorrectCode != null) {
                                            %>
                                            <%= incorrectCode %>
                                            <%
                                            } else if (error != null) {
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <a href="register.jsp" class="text-primary">Back to Register</a>
                                </div>
                                <div id="countdown">
                                    <p>Time left: <span id="seconds">60 </span></p>
                                </div>
                                <div class="d-grid">

                                ...
                                <table class="table table-hover table-nowrap">
                                    <thead class="thead-light">
                                        <tr>
                                            ...
                                            <th scope="col" style="width: 10%;">Patient</th>
                                            <th scope="col" style="width: 10%;">Doctor</th>
                                            <th scope="col" style="width: 10%;">Booking Date</th>
                                            <!--                                            <th scope="col">Examination Status</th>-->
                                            <th scope="col" style="width: 20%; margin-right: 20px">
                                                <select style=" margin-bottom: -10px; margin-top: -10px;" id="statusFilter" class="form-control" aria-label="Filter by status">

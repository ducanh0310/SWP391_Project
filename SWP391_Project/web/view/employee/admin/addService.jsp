                                    ...
                                    <div class="mb-npx">
                                        <div class="row align-items-center">
                                            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
                                                <!-- Title -->
                                                <h1 class="h2 mb-0 ls-tight">Add New Service</h1>
                                            </div>
                                            <!-- Actions -->
                                        </div>
                                    </div>
                                    ...
                                    <form action="addservice" method="POST">
                                        <div class="row mt-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="service" class="form-control" placeholder="" value="${param.service}">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="price" class="form-control" placeholder="" value="${param.price}">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" name="description" class="form-control" placeholder="" value="${param.description}">
                                                <c:if test="${not empty requestScope.descriptionError}">
                                                    <div class="text-danger">${requestScope.descriptionError}</div>
                                                </c:if>
                                            </div>        
                                        </div>
                                        <div class="mt-5 text-center">
                                            <button class="btn btn-primary py-2 px-4 ms-3" type="submit">Save Profile</button>
                                            <a class="btn btn-primary py-2 px-4 ms-3" href="viewservices">Cancel</a>
                                        </div>

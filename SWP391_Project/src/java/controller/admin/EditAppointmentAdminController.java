 ...
 * @author Vu Minh Quan
 */
@WebServlet(name = "EditAppointmentAdminController", urlPatterns = {"/appointment/editAppointment"})
public class EditAppointmentAdminController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            BookingAppointmentHistory bAH = db.getDateAppointmentEmployee(Integer.parseInt(idAppointment));
            ...
            if (flag == 1) {
                request.getRequestDispatcher("../view/employee/admin/notificationEdit.jsp").forward(request, response);
            }
            request.getRequestDispatcher("../view/employee/admin/editAppointmentHistoryAdmin.jsp").forward(request, response);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (arrRestSlot.isEmpty()) {
                ...
                for (Slot slot : arrRestSlot) {
                    jsonResponse.append("{")
//                            .append("\"idPatient\": \"").append(slot.getPatient().getId()).append("\",")

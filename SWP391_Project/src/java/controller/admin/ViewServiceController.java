 ...
 * @author ngphn
 */
@WebServlet(name = "ViewServiceController", urlPatterns = {"/ViewServiceDetail"})
public class ViewServiceController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewServiceController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewServiceController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userRole == null || "patient".equals(userRole)) {
            ...
            try {
                ...
                Logger.getLogger(ViewServiceController.class.getName()).log(Level.SEVERE, null, ex);

...
public class EmployeeDAO extends DBContext {
    ...
    public ArrayList<Employees> getAllDoctor() throws SQLException {
        ArrayList<Employees> employeeList = new ArrayList<>();
        String sql = "SELECT * FROM Employee WHERE employee_type != 'i' AND employee_type = 'd';";
        Connection connection = null;
        PreparedStatement statement = null;
        try {
            connection = getConnection();
    ...
    public ArrayList<Employees> getDoctorsByName(String name) throws SQLException {
        ArrayList<Employees> employeeList = new ArrayList<>();
        String sql = "SELECT * FROM Employee WHERE employee_type !='i' AND employee_type = 'd' AND LOWER(name) LIKE ?;";
        Connection connection = null;
        PreparedStatement statement = null;
        try {
            connection = getConnection();
    ...
    public static void main(String[] args) {
        try {
            EmployeeDAO dao = new EmployeeDAO();
                System.out.println(dao.getEmployeeByEmployeeId("i"));
        } catch (SQLException ex) {

...
public class Email {
    ...
    public static boolean sendBookingAppointment(String to, String username, Date date, String service, String room, LocalTime startTime, LocalTime endTime) {
        ...
        return sendTo(to, "Booking Appointment", "Dear " + username + "\n We have confirmed your booking deposit. Please wait for an appointment approval email from the clinic staff. Below are the details of your appointment:\n\n"
        ...
        public static boolean sendApproveBookingAppointment(String to, String username, Date date, String service, String room, LocalTime startTime, LocalTime endTime) {
        String code = generateRandomCode(6);
        return sendTo(to, "Approve Appointment - [" + code + "]", "Dear " + username + "\n We have approved your appointment. Please be mindful of the time and arrive on time. Below are the details of your appointment:\n\n"
                                                                                 + "Order Code: " + code + "\n"
                                                                                 + "Date: " + date + " " + startTime + "-" + endTime + "\n"
                                                                                 + "Service: " + service + "\n"
                                                                                 + "Room: " + room + "\n\n"
